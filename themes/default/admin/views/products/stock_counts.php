    ...
    ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('products/stock_counts') ?>"><i class="far fa-building"></i> <?= lang('all_warehouses') ?></a></li>
                            <li class="divider"></li>
                            <?php
                ...
                <div class="table-responsive">
                    <table id="STData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="primary">
                            ...
                            <th style="max-width:30px; text-align:center;"><i class="fas fa-download"></i></th>
