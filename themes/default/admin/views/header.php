...
<head>
    ...
    <noscript><style type="text/css">#loading2 { display: none; }</style></noscript>
                        ...
                        if ($Owner || $Admin) {
                                ...
                                <ul>
                                    <li id="transfers_index">
                                        <a class="submenu" href="<?= admin_url('transfers'); ?>">
                                            <i class="fa fa-random"></i><span class="text"> <?= lang('list_transfers'); ?></span>
                                        </a>
                                    </li>
                                    <li id="transfers_add">
                            ...
                            <li class="mm_returns">
                                <a class="dropmenu" href="#">
                                    ...
                                    <span class="text"> <?= lang('return_sales'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="returns_index">
                                        <a class="submenu" href="<?= admin_url('returns'); ?>">
                                            <i class="fas fa-exchange-alt"></i><span class="text"> <?= lang('list_return_sales'); ?></span>
                                        </a>
                                    </li>
                                    <li id="returns_add">
                                        <a class="submenu" href="<?= admin_url('returns/add'); ?>">
                                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_return_sales'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <?php
                            ...
                            <li class="mm_quotes">
                                ...
                                <ul>
                                    <li id="sales_index">
                                        <a class="submenu" href="<?= admin_url('quotes'); ?>">
                                            <i class="fas fa-file-signature"></i><span class="text"> <?= lang('list_quotes'); ?></span>
                                        </a>
                                    </li>
