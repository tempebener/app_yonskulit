...
class Sales extends MY_Controller
{
    ...
    public function getDeliveries()
    {
        ...
        $detail_link = anchor('admin/sales/view_delivery/$1', '<i class="far fa-file-alt"></i> ' . lang('delivery_details'), 'data-toggle="modal" data-target="#myModal"');
    ...
    public function getSales($warehouse_id = null)
    {
        ...
        $detail_link       = anchor('admin/sales/view/$1', '<i class="far fa-file-alt"></i> ' . lang('sale_details'));
